...
export default function MarketingLayout({ children }: MarketingLayoutProps) {
    ...
    return (
        <div className="flex min-h-screen flex-col bg-background text-foreground">
            <header className="sticky top-0 z-40 bg-background/95 shadow-sm shadow-border/40 backdrop-blur">
            ...
            <footer className="border-t border-border/60 bg-muted/40">
                <div className="mx-auto flex w-full max-w-6xl flex-col gap-4 px-4 py-10 text-sm text-muted-foreground sm:px-6 lg:px-8 lg:flex-row lg:items-center lg:justify-between">
                    <div>&copy; {new Date().getFullYear()} CAT score calculator official. All rights reserved.</div>
